...
</code></pre> | <p>callback으로 전달된 함수에 파라미터 값을 포함하여 호출합니다.<br>JSON 값을 stringfy하여 전달합니다.</p><p></p><p>광고 수집 동의를 거부했을 경우 "00000000-0000-0000-0000-000000000000" 값을 넘겨주시면 됩니다.<br><br>AOS : deviceADID</p><p>IOS : IDFA</p> |
