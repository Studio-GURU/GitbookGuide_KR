...
Contents.recentContentModel(
    signature = ${signature}, 
    response = object : Contents.IResponse<MutableList<RecentContentModel>> {
        override fun onSuccess(success: MutableList<RecentContentModel>) {
        }
...
Contents.recentContentModel(
    ...
    new Contents.IResponse<List<RecentContentModel>>() {
        @Override
        public void onSuccess(List<RecentContentModel> success) {
