...
```swift
ContentKit.recentContentModel(
    signKey: String, 
    completionHandler: @escaping(BehaviorDataResult<[RecentContentData]>) -> Void
)
```
{% endcode %}
...
ContentsKit.recentContentModel(signKey: signKey) { response in
    switch response {
