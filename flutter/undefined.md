...
```dart
Future<AddOnResult<List<RecommendationContentData>>> comicsRecommendationContent(
    String signKey, 
    String? adid, 
    bool? isAdult
)
...
result.response?.forEach((element) {
    print("recommendation { contentId: ${element.title}, title: ${element.title}, thumbnail: ${element.thumbnail} }");
});
```
{% endcode %}
